...
const Footer = () => {
  return (
    <footer className="w-full bg-[#0f0f0f] text-white py-4 px-4 flex flex-col items-center relative z-10">
      ...
      <nav className="flex flex-wrap gap-6 justify-center text-sm md:text-base text-gray-300 mb-3">
        ...
        <a href="#skills" className="hover:text-[#9215e6] transition-all duration-300 hover:drop-shadow-md">Skills</a>
        <a href="#projects" className="hover:text-[#9215e6] transition-all duration-300 hover:drop-shadow-md">Projects</a>
