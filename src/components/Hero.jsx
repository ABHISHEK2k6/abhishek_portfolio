  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      <div className="w-full h-full relative">
        <div className="absolute w-[50%] h-full right-0 z-[2] max-[420px]:w-full max-[420px]:h-3/4 ">
          <RobotCanvas />
        </div>
      </div>
      <div
      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop 3D models,<br className='sm:block hidden' />  Animations and web applications.
          </p>
        </div>
      </div>
